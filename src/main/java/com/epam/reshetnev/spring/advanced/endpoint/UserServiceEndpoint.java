...
import com.epam.reshetnev.spring.advanced.jaxws.user.Delete;
import com.epam.reshetnev.spring.advanced.jaxws.user.DeleteResponse;
import com.epam.reshetnev.spring.advanced.jaxws.user.GetAll;
import com.epam.reshetnev.spring.advanced.jaxws.user.GetAllByName;
import com.epam.reshetnev.spring.advanced.jaxws.user.GetAllByNameResponse;
import com.epam.reshetnev.spring.advanced.jaxws.user.GetAllResponse;
import com.epam.reshetnev.spring.advanced.jaxws.user.GetBookedTickets;
import com.epam.reshetnev.spring.advanced.jaxws.user.GetBookedTicketsResponse;
import com.epam.reshetnev.spring.advanced.jaxws.user.GetByEmail;
import com.epam.reshetnev.spring.advanced.jaxws.user.GetByEmailResponse;
import com.epam.reshetnev.spring.advanced.jaxws.user.GetById;
import com.epam.reshetnev.spring.advanced.jaxws.user.GetByIdResponse;
import com.epam.reshetnev.spring.advanced.jaxws.user.Save;
import com.epam.reshetnev.spring.advanced.jaxws.user.SaveAll;
import com.epam.reshetnev.spring.advanced.jaxws.user.SaveAllResponse;
import com.epam.reshetnev.spring.advanced.jaxws.user.SaveResponse;
import com.epam.reshetnev.spring.advanced.jaxws.user.Update;
import com.epam.reshetnev.spring.advanced.jaxws.user.UpdateResponse;
